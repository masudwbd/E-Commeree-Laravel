                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-6">
                                                <label for="product_code">Product Code</label><span class="text-danger">
                                                    *</span>
                                                <input type="text" class="form-control" value="{{old ('code')}}" id="code"
                                                    name="code">
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-6">
                                                <label for="tags" data-role="tagsinput">Tags</label><span class="text-danger">
                                                    *</span>
                                                <input type="tags"  value="{{old('tags')}}" class="form-control" name="tags"
                                                value="">
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-12">
                                                <label for="description">Description</label><span class="text-danger">
                                                    *</span>
                                                <textarea type="text " value="{{old('description')}}" class="form-control textarea" name="description"></textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-12">
                                                <label for="video">Video</label><span class="text-danger">
                                                    *</span>
                                                <textarea type="text" value="{{old('video')}}" class="form-control" name="video"></textarea>
                                            </div>
                                        </div>
                                    </div>
                            </div>
